...
const files = ['Ket_Noi_KhoDuLieu.cmd', 'Ket_Noi_KhoTriThuc.cmd', 'Chuyen_Du_Lieu_AGiaoAn.cmd', 'Cai_Dat_Cong_Cu.cmd', 'Kiem_Tra_AWord.cmd', 'Bat_Doc_Web.cmd', 'Dong_Goi_AWord.bat'];
