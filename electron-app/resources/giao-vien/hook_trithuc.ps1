...
# (vd https://trithuc.aword.vn/api/v1/thong-bao?doc=1) voi 2 header xac thuc thiet bi
...
try {
    ...
    # URL goc = URL MCP bo duoi "/mcp" (vd https://trithuc.aword.vn/mcp -> https://trithuc.aword.vn)
