...
| Mục | Chốt |
|---|---|
| Tạo tài khoản | Quản trị hệ thống / quản trị đơn vị tạo (lẻ hoặc nhập Excel/CSV); đổi mật khẩu lần đầu; quản trị bắt buộc xác thực hai lớp |
...
- Sai mật khẩu 5 lần → khóa 15 phút; quản trị bắt buộc bật xác thực hai lớp; tài khoản mới phải đổi mật khẩu lần đầu.
